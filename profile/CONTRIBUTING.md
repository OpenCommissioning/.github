...
Please review our [Code of Conduct](https://github.com/OpenCommissioning/.github/profile/CODE_OF_CONDUCT.md). It is in effect at all times. We expect it to be honored by everyone who contributes to this project. Acting like an asshole will not be tolerated.

## :bulb: Asking Questions

See our [Support Guide](https://github.com/OpenCommissioning/.github/profile/SUPPORT.md). In short, GitHub issues are not the appropriate place to debug your specific project, but should be reserved for filing bugs and feature requests.
...
Review our [Security Policy](https://github.com/OpenCommissioning/.github/profile/SECURITY.md). **Do not** file a public issue for security vulnerabilities.
...
- **Review the documentation and [Support Guide](https://github.com/OpenCommissioning/.github/profile/SUPPORT.md)** before opening a new issue.
...
Original guide written by [@jessesquires](https://github.com/jessesquires) and inspired by work from the following communities:
